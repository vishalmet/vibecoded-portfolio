...
const Ballpit = ({
  className = " bg-gradient-to-tr from-black via-black to-gray-500 max-h-screen",
  followCursor = true,
  ...props
}) => {
  ...
  const handleScroll = () => {
    const targetElement = document.getElementById("create");
    if (targetElement) {
    ...
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      >
        <div className=" text-center w-[900px]">
          <ShinyText text="LAUNCH YOUR TOKEN" disabled={false} speed={3} className='custom-class text-7xl font-bold' />
          <p className=" text-white/70 text-3xl">The fastest way to create and deploy your own token on the blockchain. No coding required.</p>
          <StarBorder
            onClick={handleScroll}
            as="button"
            className="custom-class text-2xl cursor-pointer mt-2 hover:scale-95 transition-transform duration-300"
            color="white"
            speed="5s"
          >
            Launch now
